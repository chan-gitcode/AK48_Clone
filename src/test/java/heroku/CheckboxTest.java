...
/*    TC02: Checkboxes : Check to a box
    ...
    @Test
    void theCheckboxesShouldDeselect(){
        WebElement checkbox1 = driver.findElement(By
                .xpath("//form[@id='checkboxes']//input[@type='checkbox']" +
                        "[following-sibling::text()[contains(.,'checkbox 1')]]"));
        uncheck(checkbox1);
        Assert.assertFalse(driver.findElement(By
                .xpath("//form[@id='checkboxes']//input[@type='checkbox']" +
                "[following-sibling::text()[contains(.,'checkbox 1')]]")).isSelected());
